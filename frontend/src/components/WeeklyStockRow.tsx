...
interface WeeklyStockRowProps {
  stock: WeeklyStockMatch;
...
export default function WeeklyStockRow({ stock, lastScannedAt }: WeeklyStockRowProps) {
  ...
  return (
    <article className="golden-stock-row weekly-stock-row">
      <div className="golden-stock-row-head">
        ...
        <div className="golden-stock-row-growth">
          ...
          <span className="golden-badge golden-badge-price" title="Weekly YoY / 4-week">
            Weekly {fmtPct(stock.price_yoy_pct)} / {fmtPct(stock.price_qoq_pct)}
          </span>
